        ...
        <main className="relative px-6 pt-32">
            ...
            },
            {
              ...
              icon: (
                ...
                <div key={i} className="group relative overflow-hidden rounded-2xl bg-zinc-900 p-8 transition-all hover:bg-zinc-800/80">
                ...
                {/**Trust Badge */}
                <div className="mt-40 mb-3 flex justify-center">
